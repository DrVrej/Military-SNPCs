...
-----------------------------------------------*/
ENT.Model = {"models/VJ_HGRUNT/hgrunt1.mdl","models/VJ_HGRUNT/hgrunt2.mdl","models/VJ_HGRUNT/hgrunt3.mdl","models/VJ_HGRUNT/hgrunt4.mdl","models/VJ_HGRUNT/hgrunt5.mdl"} -- Model(s) to spawn with | Picks a random one if it's a table 
ENT.StartHealth = 60

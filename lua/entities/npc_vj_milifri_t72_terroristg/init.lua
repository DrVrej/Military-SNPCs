...
-----------------------------------------------*/
ENT.Model = {"models/vehicles/t72_turret.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want 
ENT.StartHealth = 0
---------------------------------------------------------------------------------------------------------------------------------------------
...
util.AddNetworkString("vj_mili_terroristt72g_shooteffects")
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:StartShootEffects()
	net.Start("vj_mili_terroristt72g_shooteffects")

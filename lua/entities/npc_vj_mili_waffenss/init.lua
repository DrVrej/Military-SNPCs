...
-----------------------------------------------*/
ENT.Model = {"models/VJ_SS/soldier_1.mdl","models/VJ_SS/soldier_2.mdl","models/VJ_SS/soldier_3.mdl","models/VJ_SS/soldier_g1.mdl","models/VJ_SS/soldier_g2.mdl"} -- Model(s) to spawn with | Picks a random one if it's a table 
ENT.StartHealth = 90

...
if CLIENT then
local Name = "Friendly Terrorist T-72"
local LangName = "npc_vj_milifri_t72_terrorist"
...
---------------------------------------------------------------------------------------------------------------------------------------------
net.Receive("vj_mili_terroristt72_spawneffects", function()
...
---------------------------------------------------------------------------------------------------------------------------------------------
net.Receive("vj_mili_terroristt72_moveeffects", function()
	local ent = net.ReadEntity()
	if ent:IsValid() then
	ent.Emitter = ParticleEmitter(ent:GetPos())

...
ENT.StartHealth = GetConVarNumber("vj_mili_t72_soviet_h")
---------------------------------------------------------------------------------------------------------------------------------------------
...
util.AddNetworkString("vj_mili_t72_spawneffects")
...
function ENT:StartSpawnEffects()
	net.Start("vj_mili_t72_spawneffects")
	net.WriteEntity(self)
	net.Broadcast()
end
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:StartMoveEffects()
	net.Start("vj_mili_t72_moveeffects")
	net.WriteEntity(self)
	net.Broadcast()
end
---------------------------------------------------------------------------------------------------------------------------------------------

...
-----------------------------------------------*/
ENT.Model = {"models/VJ_DODGERMANS/german_soldier1.mdl","models/VJ_DODGERMANS/german_soldier2.mdl","models/VJ_DODGERMANS/german_soldier3.mdl","models/VJ_DODGERMANS/german_soldier4.mdl","models/VJ_DODGERMANS/german_soldier5.mdl","models/VJ_DODGERMANS/german_soldier6.mdl"} -- Model(s) to spawn with | Picks a random one if it's a table 
ENT.StartHealth = 60

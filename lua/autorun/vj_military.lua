...
if VJExists == true then
	...
	-- Enemy
		...
		VJ.AddNPC("Random Soviet Infantry (Enemy)", "sent_vj_mili_randsoviet", spawnCategory)
		-- Insurgents
	...
	-- Friendly
		...
		VJ.AddNPC("Random Soviet Infantry (Friendly)", "sent_vj_milifri_randsoviet", spawnCategory)
		-- Insurgents
